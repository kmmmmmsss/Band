...
<div id="board_content">
	...
	<div id="comment_wrap">
		<!-- 댓글 입력창 -->
		<form method="post" name="insert" action="/comment/mupdate">
		...
		<input type="hidden" id="m_no" name="m_no" value='<c:out value="${comment.m_no}"/>'>
		<input type="hidden" name="pageNum" value='<c:out value="${cri.pageNum}"/>'>
		<input type="hidden" name="amount" value='<c:out value="${cri.amount}"/>'>
		</form>
	</div>
</div>
	<form id="viewForm" action="/comment/mupdate" method="get">
		<input type="hidden" name="keyword" value="${cri.keyword}">
		<input type="hidden" name="type" value="${cri.type}">
		<input type="hidden" id="m_no" name="m_no" value='<c:out value="${comment.m_no}"/>'>
...
$("#cmt_back").on("click", function(e){
	viewto.attr("action","/match/mview");
	viewto.submit();
})
...
$("#cmtdeleteBtn").on("click", function(){
	...
	if(result){
		viewto.attr("action", "/comment/delete/"+rno);
...
$(".cmt_md").on('click', function(e){
	...
	viewmodify.attr("action", "/comment/mupdate");
